...
const CardHorizontalVideo = (props) => {
    const navigation = props.navigation;

    return (
            <View style={styles.cardVideoHorizontalCard}>
                <View style={{ position: 'relative', }}>
                    <Image style={{ aspectRatio: 16 / 9, resizeMode: 'cover', }} source={{ uri: `https://img.youtube.com/vi/${props.videoId}/hqdefault.jpg` }} />
...
export default CardHorizontalVideo;